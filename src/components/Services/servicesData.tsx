...
const servicesData: Services[] = [

  {
    ...
    title: "Tashrif qog'oz yaratish",
    paragraph:
      "Uzingiz uchun shaxsiy yoki kampaniyangiz uchun tashrif qog'oz yaratishingiz mumkin. Tashrif qog'oz yaratishni boshlashingiz yoki mavjud shablonlardan foydananishingiz mumkin.",
    link: "/create-visit-card/blank",
  },
  {
    id: 2,
    icon: (
    ...
    title: "Tabriknomani yaratish",
    paragraph:
      "Turli xil bayram, tug'ilgan kun yoki boshqalar shunga o'xshash tadbirlar uchun o'zingizni tabriknomangizni 0 dan yoki shablon asosida yaratishingiz mumkin.",
    link: "/create-banner/blank",
  },
  {
    id: 3,
    icon: (
    ...
    title: "Taklifnoma yaratish",
    paragraph:
      "Turli marosimlar uchun har xil turdagi taklifnomalarni yaratishingiz mumkin. Taklifnoma yaratishni boshidan boshlashingiz yoki tayyor shablonni tanlashingiz mumkin.",
    link: "#",
  },
];
